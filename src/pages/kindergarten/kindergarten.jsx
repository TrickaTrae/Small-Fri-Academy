...
const Kindergarten = () => {
    return (
        <div id="kindergarten" className="fade-in-fwd">
            <img className="img-fluid w-100" src="https://small-fri-academy.s3.us-west-1.amazonaws.com/Kindergarten-1.jpg" alt="School Age Kids" />

            <div className="container py-5">
                <div className="row py-4">
                    <div className="col-12 text-center">
                        <h1 className="m-0 display-2 fw-normal">Kindergarten</h1>
                    </div>
                </div>
                ...
                <div className="row py-4">
                    <div className="col-12">
                        <h4 className="m-0">
                            ...
                            <br/><br/>
                            Large motor skill activities include games which teach hopping, jumping, skipping, galloping,
                ...
                <div className="row py-4">
                    <div className="col-12 col-lg-4 pb-5">
                        <img className="img-fluid rounded" src="https://small-fri-academy.s3.us-west-1.amazonaws.com/Kindergarten-2.jpg" alt="School Age Kids" />
                    </div>
