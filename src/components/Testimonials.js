                    ...
                    <div className="container-fluid">
                        ...
                        <div className="row">
                            <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <p className="testimonial-left charles">
                        ...
                        <div className="row">
                            ...
                            <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <p className="testimonial-right nicolette">
                        ...
                        <div className="row">
                            ...
                            <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <p className="testimonial-right kathryn">
                        ...
                        <div className="row">
                            ...
                            <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <p className="testimonial-right leslie">
                        ...
                        <div className="row">
                            ...
                            <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <p className="testimonial-right amonrat">
